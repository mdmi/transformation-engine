...
public class SimplifiedSemanticParser implements ISemanticParser {
	...
	public void updateSyntacticModel(MessageModel mdl, ElementValueSet elementValueSet, ISyntaxNode yr,
		...
		System.err.println("startstartstartstartstartstartstartstartstart ");
		ListIterator<IElementValue> iterator2 = elementValueSet.getAllElementValues().listIterator();

		while (iterator2.hasNext()) {
			IElementValue elementValue = iterator2.next();
			if (elementValue.getSemanticElement() != null) {

				System.err.println("normalizeSemanticContainers " + elementValue.getName());
				normalizeSemanticContainers(elementValueSet, elementValue, iterator2, containers);
			}
		}
	...
	public void updateTargetSemanticModel(MessageModel mdl, ElementValueSet elementValueSet, ISyntaxNode yr,
		...
		System.err.println("endendendendendendendendendendendendendendendendend ");

		// XXXXwalkComputedIn(mdl, elementValueSet, properties, containers);
		watch.split();
		logger.trace("walkComputedIn: " + watch.toSplitString());
	...
	void XXXXwalkComputedIn(MessageModel mdl, ElementValueSet elementValueSet, Properties properties,
			HashMap<String, IElementValue> containers) {

		// System.err.println("XXXXwalkComputedInXXXXwalkComputedInXXXXwalkComputedInXXXXwalkComputedIn");
		// for (String xxx : containers.keySet()) {
